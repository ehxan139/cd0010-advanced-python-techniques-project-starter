...
class AttributeFilter:
    ...
    def __repr__(self):
        """Machine readable representation of the class objects."""
        return (f"{self.__class__.__name__}(op=operator.{self.op.__name__}, "
                f"value={self.value})")


class CreateDateFilter(AttributeFilter):
    """SubClass of AttributeFilter class. It filters close approach NEO based on dates."""
...
class CreateDistanceFilter(AttributeFilter):
    """SubClass of AttributeFilter class. It filters close approach NEO based on distance."""
...
class CreateVelocityFilter(AttributeFilter):
    """SubClass of AttributeFilter class. It filters close approach NEO based on velocity."""
...
class CreateDiameterFilter(AttributeFilter):
    """SubClass of AttributeFilter class. It filters close approach NEO based on diameter."""
...
class CreateHazardousFilter(AttributeFilter):
    """SubClass of AttributeFilter class. It filters close approach NEO based on if they are hazardous or not."""
