...
class NEODatabase:
    ...
    def __init__(self, neos, approaches):
        ...
        self.neo_by_designation = defaultdict()
        self.neo_by_name = defaultdict()
        ...
        for approach in self._approaches:
            ...
            if neo is not None:
                ...
                # If same object is stored in self.neo_by_designation and
                # self.neo_by_name then we don't have to run following lines.
                # Otherwise we have to store it twice.
                # neo_name = self.neo_by_designation[approach._designation] \
                # .name
                # if neo_name is not None:
                #     self.neo_by_name[neo_name].approaches.append(approach)
